...
al. (\citeproc{ref-warstadtFindingsBabyLMChallenge2023}{2023}){]} can
...
interaction between them (\textbf{?@eq-gammfull}).}
...
(\citeproc{ref-linSyntacticAnnotationsGoogle2012}{2012}){]}.
...
(\citeproc{ref-tenney2019bertrediscoversclassical}{2019}){]}, it is
...
Morgan et al.
(\citeproc{ref-morganFormalizingConstructionGrammar}{2023}){]}. However,
