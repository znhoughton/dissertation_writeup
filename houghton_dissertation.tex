...
\& Levy (\citeproc{ref-morgan2015}{2015}) examined whether this finding
...
(\citeproc{ref-morgan2015}{2015}) developed a probabilistic model to
...
storage (\citeproc{ref-bybee2003}{Bybee, 2003};
\citeproc{ref-bybee2001}{Bybee \& Hopper, 2001};
\citeproc{ref-bybeeEffectUsageDegrees1999}{Bybee \& Scheibman, 1999};
...
information (\citeproc{ref-bansal2018functionfailuresensory}{Bansal et
al., 2018}; \citeproc{ref-clark2013arewepredictive}{Clark, 2013};
...
(\citeproc{ref-lebrun2022evaluatingdistributionaldistortion}{2022}).
...
(\citeproc{ref-misraLanguageModelsLearn2024}{2024}). They examined
...
(\citeproc{ref-zhengTakeStepBack2024}{n.d.}) used a novel prompting
...
(\citeproc{ref-mccoyUniversalLinguisticInductive2020}{n.d.})
...
(\citeproc{ref-morgan2015}{Morgan \& Levy, 2015},
\citeproc{ref-morganAbstractKnowledgeDirect2016}{2016a},
\citeproc{ref-morgan2024}{2024}). In order to capture the abstract
ordering preferences of humans across binomial constructions, Morgan \&
Levy (\citeproc{ref-morganAbstractKnowledgeDirect2016}{2016a}) developed
...
\pandocbounded{\includegraphics[keepaspectratio]{Chapters/LLM Ordering Prefs/Figures/full_plot.pdf}}
...
\citeproc{ref-piantadosiChapterModernLanguage}{Piantadosi, 2023};
\citeproc{ref-piantadosiMeaningReferenceLarge2022}{Piantadosi \& Hill,
2022}). These questions have stemmed from clear differences in terms of
...
training data (\citeproc{ref-haleyThisBERTNow2020}{Haley, 2020};
\citeproc{ref-lasriSubjectVerbAgreement2022}{Lasri et al., 2022};
\citeproc{ref-liAssessingCapacityTransformer2023}{Li et al., 2023};
\citeproc{ref-liAreNeuralNetworks2021}{Li \& Wisniewski, 2021};
\citeproc{ref-mccoyHowMuchLanguage2023}{McCoy et al., 2023};
...
OLMo 1B and OLMo 7B
(\citeproc{ref-groeneveldOLMoAcceleratingScience2024}{Groeneveld et al.,
2024}).\footnote{All of our code can be found publicly available at
...
for those models, the embeddings for ordering of the binomial that is
more frequent (i.e., higher relative frequency) are less similar to the
...
embeddings for high relative frequency binomials and the compositional
embeddings is even greater in high-frequency binomials than
low-frequency ones.
...
Experiment 1, with two main exceptions: first, rather than examining
several different large language models, we instead examined a single
large language model: OlmO 1B. OlmO 1B has released checkpoints at
different stages in learning. As such, we can examine the
representations of binomials at different stages of learning. Second, we
also examined the representations at each hidden layer in the model in
order to examine how the representation changes across layers.

For the present study, we examine the embeddings for our sentences from
...
(\citeproc{ref-kapatsinski2018}{2018}); Robenalt \& Goldberg
(\citeproc{ref-robenaltJudgmentEvidenceStatistical2015}{2015});
Theakston
(\citeproc{ref-theakstonRoleEntrenchmentChildren2004}{2004}){]}.
...
Griffiths \& Kalish
(\citeproc{ref-griffithsLanguageEvolutionIterated2007}{2007}). They
