...
(\citeproc{ref-al-selwiLSTMInefficiencyLongterm2023}{2023}); Bengio et
al. (\citeproc{ref-bengioProblemLearningLongterm1993}{1993}){]}. The
...
\emph{peanut butter}, is \emph{peanut b\ldots{}} enough evidence for a
reader to access the holistically stored representation? To address this
...
well (\citeproc{ref-coltheart1977access}{Coltheart et al., 1977}).
...
Morgan et al.
(\citeproc{ref-morganFormalizingConstructionGrammar}{2023}){]}. This is
