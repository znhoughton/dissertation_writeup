...
model_config = AutoConfig.from_pretrained(model_id, trust_remote_code = True, token = hf_token
...
binom_probs_df.to_csv('falcon180b_2afc_just_binom_ordering_prefs.csv', index = False)